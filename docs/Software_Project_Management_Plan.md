...
The release plan for this project will be available soon on a [specific document](https://github.com/teddyedo/2020_5EI_team1_Allari/master/docs/Release_Plan.md)

## Iteration plan

The iteration plan for this project will be available soon on a [specific document](https://github.com/teddyedo/2020_5EI_team1_Allari/master/docs/Iteration_Plan.md)

# Test plan

The test plan for this project will be available soon on a [specific document](https://github.com/teddyedo/2020_5EI_team1_Allari/master/docs/Test_Plan.md)
